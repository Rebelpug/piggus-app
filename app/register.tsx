          ...
          <View style={styles.form}>
              ...
              >
                ...
                <View
                  style={[
                    ...
                    { opacity: /[a-z]/.test(password) ? 0.4 : 1 },
                  ]}
                >
                  <Ionicons
                    name={
                ...
                <View
                  style={[
                    styles.requirementItem,
                    { opacity: /[0-9]/.test(password) ? 0.4 : 1 },
                  ]}
                >
                  <Ionicons
                    name={
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    loading || !acceptTerms ? colors.icon : colors.primary,
                },
