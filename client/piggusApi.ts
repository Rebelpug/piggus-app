...
export interface PiggusApi {
  ...
  addExpense: (
    groupId: string,
    data: { expenseId: string; encryptedData: any; created_at?: string },
  ) => Promise<Expense>;
  updateExpense: (
    groupId: string,
    expenseId: string,
    data: { encryptedData: any; created_at?: string },
  ) => Promise<Expense>;
  deleteExpense: (
    groupId: string,
    expenseId: string,
  ) => Promise<{ success: boolean }>;
  inviteToExpenseGroup: (
    groupId: string,
    data: { username: string; encryptedGroupKey: string },
  ) => Promise<ExpenseGroupMembership>;
  handleExpenseGroupInvite: (
    groupId: string,
    data: { accept: boolean },
  ) => Promise<{ success: boolean }>;
  ...
  getPortfolios: () => Promise<
    (PortfolioMembership & { portfolios: Portfolio })[]
  >;
  ...
  addInvestment: (
    portfolioId: string,
    data: { investmentId: string; encryptedData: any },
  ) => Promise<Investment>;
  updateInvestment: (
    portfolioId: string,
    investmentId: string,
  ...
  inviteToPortfolio: (
    portfolioId: string,
    data: { username: string; encryptedPortfolioKey: string },
  ) => Promise<PortfolioMembership>;
  handlePortfolioInvite: (
    portfolioId: string,
    data: { accept: boolean },
  ) => Promise<{ success: boolean }>;
  ...
  searchProfiles: (
    ...
    { id: string; username: string; encryption_public_key: string }[]
  >;

  // Recurring Expense Methods
  getRecurringExpenses: () => Promise<
    (RecurringExpense & { group_membership: any })[]
  >;
  ...
  updateRecurringExpense: (
    recurringId: string,
    data: { groupId: string; encryptedData: any },
  ) => Promise<RecurringExpense>;
...
export const piggusApi: PiggusApi = {
  ...
  createExpenseGroup: async (data) => {
    ...
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/expense-groups`,
      data,
    );
    return response.data;
  },
  ...
  getExpenseGroup: async (groupId: string) => {
    ...
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/expense-groups/${groupId}`,
    );
    return response.data;
  },
  ...
  getExpensesForGroup: async (groupId: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/expenses`,
    );
    return response.data;
  },

  getExpensesForGroupPaginated: async (
    groupId: string,
    params: {
      page: number;
      limit: number;
    ...
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/expenses/paginated?${searchParams.toString()}`,
    );
    return response.data;
  },
  ...
  updateExpense: async (groupId: string, expenseId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.put(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/expenses/${expenseId}`,
      data,
    );
    return response.data;
  },
  ...
  inviteToExpenseGroup: async (groupId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/invite`,
      data,
    );
    return response.data;
  },
  ...
  handleExpenseGroupInvite: async (groupId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/handle-invite`,
      data,
    );
    return response.data;
  },
  ...
  removeExpenseGroupMember: async (groupId: string, userId: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.delete(
      `${BASE_URL}/api/v1/expense-groups/${groupId}/members/${userId}`,
    );
    return response.data;
  },
  ...
  getInvestmentsForPortfolio: async (portfolioId: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/portfolios/${portfolioId}/investments`,
    );
    return response.data;
  },
  ...
  updateInvestment: async (portfolioId: string, investmentId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.put(
      `${BASE_URL}/api/v1/portfolios/${portfolioId}/investments/${investmentId}`,
      data,
    );
    return response.data;
  },
  ...
  inviteToPortfolio: async (portfolioId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/portfolios/${portfolioId}/invite`,
      data,
    );
    return response.data;
  },
  ...
  handlePortfolioInvite: async (portfolioId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/portfolios/${portfolioId}/handle-invite`,
      data,
    );
    return response.data;
  },
  ...
  removePortfolioMember: async (portfolioId: string, userId: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.delete(
      `${BASE_URL}/api/v1/portfolios/${portfolioId}/members/${userId}`,
    );
    return response.data;
  },
  ...
  lookupInvestmentBySymbol: async (
    symbol: string,
    exchangeMarket: string,
    type: string,
    currency: string,
  ...
  searchProfiles: async (query: string, limit: number = 10) => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/profile/search?q=${encodeURIComponent(query)}&limit=${limit}`,
    );
    return response.data;
  },
  ...
  getRecurringExpenses: async () => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/recurring-expenses`,
    );
    return response.data;
  },
  ...
  updateRecurringExpense: async (recurringId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.put(
      `${BASE_URL}/api/v1/recurring-expenses/${recurringId}`,
      data,
    );
    return response.data;
  },
  ...
  generateExpenseFromRecurring: async (recurringId: string, data) => {
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/recurring-expenses/${recurringId}/generate`,
      data,
    );
    return response.data;
  },
  ...
  getGuide: async (guideId: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/guides/${guideId}`,
    );
    return response.data;
  },
  ...
  getBankInstitutions: async (countryCode: string) => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/bank-institutions/${countryCode.toUpperCase()}`,
    );
    return response.data.data;
  },

  createBankAgreement: async (
    institutionId: string,
    ...
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/bank-agreements`,
      {
        institutionId,
        maxHistoricalDays,
        accessValidForDays,
  ...
  createBankRequisition: async (
    ...
    const httpClient = getHttpClient();
    const response = await httpClient.post(
      `${BASE_URL}/api/v1/bank-requisitions`,
      {
        redirectUrl,
        institutionId,
        agreementId,
  ...
  getBankTransactions: async () => {
    const httpClient = getHttpClient();
    const response = await httpClient.get(
      `${BASE_URL}/api/v1/bank-transactions`,
    );
    return response.data.data;
  },
  ...
  disconnectBank: async () => {
    const httpClient = getHttpClient();
    const response = await httpClient.delete(
      `${BASE_URL}/api/v1/bank-connection`,
    );
    return response.data;
  },

  // Bulk Operations
  bulkAddUpdateExpenses: async (
    expenses: {
      id: string;
      encrypted_data: any;
      group_id: string;
