...
export default function BankConnectionWizard({
  visible,
  onClose,
    ...
    >
      ...
      >
        <Layout style={styles.restrictionItem}>
          ...
          <Text
            category="s2"
            style={[styles.restrictionText, { color: colors.primary }]}
          >
  ...
  const renderSecondStep = () => (
    ...
    >
      ...
      <Select
        ...
        value={
          selectedCountryIndex ? COUNTRIES[selectedCountryIndex.row].name : ""
        }
    ...
    <Layout style={styles.scrollableStep}>
      <Layout style={styles.stepHeader}>
        ...
        <Input
          ...
          accessoryLeft={(props) => (
            <Ionicons name="search" size={20} color={props?.tintColor} />
          )}
          accessoryRight={
            searchQuery
              ? (props) => (
