...
const getSystemLanguage = (): string => {
  try {
    ...
    const supportedLanguages = ['en', 'es', 'fr', 'de', 'it', 'pt', 'nl', 'pl', 'sv'];
    ...
    const languageCode = systemLocale.includes('-') ? systemLocale.split('-')[0] : systemLocale;
    ...
    console.log(`Detected system language: ${systemLocale}, using: ${selectedLanguage}`);
